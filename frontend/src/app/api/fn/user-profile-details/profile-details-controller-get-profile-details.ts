...
export function profileDetailsControllerGetProfileDetails(http: HttpClient, rootUrl: string, params: ProfileDetailsControllerGetProfileDetails$Params, context?: HttpContext): Observable<StrictHttpResponse<UserDto>> {
