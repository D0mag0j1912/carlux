...
export function authControllerSendSms(http: HttpClient, rootUrl: string, params: AuthControllerSendSms$Params, context?: HttpContext): Observable<StrictHttpResponse<StatusResponseDto>> {
