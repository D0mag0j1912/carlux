...
import {
    AuthControllerEmailExists$Params,
    authControllerEmailExists,
} from '../fn/authentication/auth-controller-email-exists';
import {
    AuthControllerRegister$Params,
    authControllerRegister,
} from '../fn/authentication/auth-controller-register';
import {
    AuthControllerSendSms$Params,
    authControllerSendSms,
} from '../fn/authentication/auth-controller-send-sms';
import {
    AuthControllerSignIn$Params,
    authControllerSignIn,
} from '../fn/authentication/auth-controller-sign-in';
import {
    AuthControllerVerifyCode$Params,
    authControllerVerifyCode,
} from '../fn/authentication/auth-controller-verify-code';
...
export class AuthenticationService extends BaseService {
     ...
     */
    authControllerSendSms$Response(
     ...
     * This method sends `application/json` and handles request body of type `application/json`.
     */
    authControllerVerifyCode$Response(
     ...
     */
    authControllerEmailExists$Response(
        params: AuthControllerEmailExists$Params,
        context?: HttpContext,
     ...
     * This method sends `application/json` and handles request body of type `application/json`.
     */
    authControllerSignIn$Response(
        params: AuthControllerSignIn$Params,
        context?: HttpContext,
    ): Observable<StrictHttpResponse<LoginResponseDto>> {
