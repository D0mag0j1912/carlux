...
import {
    ProfileDetailsControllerGetProfileDetails$Params,
    profileDetailsControllerGetProfileDetails,
} from '../fn/user-profile-details/profile-details-controller-get-profile-details';
import {
    ProfileDetailsControllerSaveProfileDetails$Params,
    profileDetailsControllerSaveProfileDetails,
} from '../fn/user-profile-details/profile-details-controller-save-profile-details';
...
export class UserProfileDetailsService extends BaseService {
     ...
     */
    profileDetailsControllerGetProfileDetails$Response(
     ...
     */
    profileDetailsControllerSaveProfileDetails$Response(
        params: ProfileDetailsControllerSaveProfileDetails$Params,
        context?: HttpContext,
    ): Observable<StrictHttpResponse<UserDto>> {
