...
import { basicInfoControllerGetCarBrands } from '../fn/basic-car-information/basic-info-controller-get-car-brands';
import { BasicInfoControllerGetCarBrands$Params } from '../fn/basic-car-information/basic-info-controller-get-car-brands';
import { basicInfoControllerGetCarModels } from '../fn/basic-car-information/basic-info-controller-get-car-models';
import { BasicInfoControllerGetCarModels$Params } from '../fn/basic-car-information/basic-info-controller-get-car-models';
...
export class BasicCarInformationService extends BaseService {
   ...
   */
  basicInfoControllerGetCarBrands$Response(params?: BasicInfoControllerGetCarBrands$Params, context?: HttpContext): Observable<StrictHttpResponse<Array<CarBrandDto>>> {
   ...
   * This method doesn't expect any request body.
   */
  basicInfoControllerGetCarBrands(params?: BasicInfoControllerGetCarBrands$Params, context?: HttpContext): Observable<Array<CarBrandDto>> {
   ...
   * This method doesn't expect any request body.
   */
  basicInfoControllerGetCarModels$Response(params: BasicInfoControllerGetCarModels$Params, context?: HttpContext): Observable<StrictHttpResponse<Array<CarModelDto>>> {
   ...
   * This method doesn't expect any request body.
   */
  basicInfoControllerGetCarModels(params: BasicInfoControllerGetCarModels$Params, context?: HttpContext): Observable<Array<CarModelDto>> {
