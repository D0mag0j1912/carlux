...
import {
    CarDetailsControllerGetCarDetails$Params,
    carDetailsControllerGetCarDetails,
} from '../fn/car-details/car-details-controller-get-car-details';
...
export class CarDetailsService extends BaseService {
     ...
     */
    carDetailsControllerGetCarDetails$Response(
