...
import {
    PreferencesControllerChangeLanguage$Params,
    preferencesControllerChangeLanguage,
} from '../fn/preferences/preferences-controller-change-language';
import {
    PreferencesControllerGetPreferences$Params,
    preferencesControllerGetPreferences,
} from '../fn/preferences/preferences-controller-get-preferences';
...
export class PreferencesService extends BaseService {
     ...
     */
    preferencesControllerChangeLanguage$Response(
     ...
     */
    preferencesControllerGetPreferences$Response(
