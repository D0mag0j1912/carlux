...
import {
    CarsControllerGetCars$Params,
    carsControllerGetCars,
} from '../fn/car-list/cars-controller-get-cars';
import {
    CarsControllerGetCarsFiltersCount$Params,
    carsControllerGetCarsFiltersCount,
} from '../fn/car-list/cars-controller-get-cars-filters-count';
...
export class CarListService extends BaseService {
     ...
     */
    carsControllerGetCars$Response(
        params: CarsControllerGetCars$Params,
        context?: HttpContext,
    ): Observable<
        StrictHttpResponse<
            PaginationDto & {
     ...
     * This method doesn't expect any request body.
     */
    carsControllerGetCarsFiltersCount$Response(
